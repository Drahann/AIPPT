...
FONTMAP = {
    ...
    # ---- 良药智纪 deck: real families not installed -> in-category substitutes that ARE installed here ----
    '汉仪粗宋简': "'汉仪粗宋简','方正粗宋_GBK','Noto Serif SC','SimSun',serif",
    '汉仪雅酷黑简': "'汉仪雅酷黑简','Noto Sans SC','阿里汉仪智能黑体','Microsoft YaHei',sans-serif",
    '汉仪雅酷黑W': "'汉仪雅酷黑W','Noto Sans SC','阿里汉仪智能黑体','Microsoft YaHei',sans-serif",
    '潮字社曾玉波手书简': "'潮字社曾玉波手书简','REEJI-CHAO-ZengGB','Noto Serif SC','Microsoft YaHei',sans-serif",
}
